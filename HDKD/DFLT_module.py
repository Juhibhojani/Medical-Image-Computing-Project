...
class DFLT(nn.Module):
    ...
    def __init__(self, image_size, patch_size, dim, depth, heads, expansion, channels, use_distillation=True, dim_head = 32, dropout = 0., emb_dropout = 0.):
        ...
        self.to_patch_embedding = nn.Sequential(
            # Image = sequence of patches view of image for transformer
            Rearrange('b c (h p1) (w p2) -> b (h w) (p1 p2 c)', p1 = patch_height, p2 = patch_width),
            # each patch is individually normalized
            nn.LayerNorm(patch_dim),
            # converting to required dim
    ...
    def forward(self, img):
        ...
        # batch size, number of patches, patch dim
        b, n, _ = x.shape
