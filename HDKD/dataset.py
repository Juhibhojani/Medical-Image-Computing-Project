...
def build_dataset(is_train,args):
    ...
    if is_train and args.use_smote:
        ...
        # building dataset without transforms
        print(f"Validating the train path:{os.path.join(args.data_path,folder)}")
...
# COMMENT : transformations performed : randomrotation, flip horizontal/vertical,Color jitter, adjust brightness, adjust blurr,adjust sharpness, normalize 
